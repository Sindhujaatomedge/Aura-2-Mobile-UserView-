...
class _AttendancerequestState extends StateMVC<Attendancerequest>
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      var Attendancerequest =
                                          _con.requestattendancelistlog[index];
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        SizedBox(
                                                                         ...
                                                                         Center(child:
                                                                         Text('${formatDate(Attendancerequest.checkindate.toString())} - ${formatDate(Attendancerequest.checkoutdate.toString())}',style: TextStyle(color: Color( 0xFF030303),fontSize: 12,fontFamily: 'Poppins'),),),
                                                                      ],
                                                                    ),
                                                                            ...
                                                                            label: Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Center(
                                                                                    child: const Text(
                                                                                  "Reject",
                                                                                  style: TextStyle(fontFamily: 'Poppins', fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xFF030303)),
                                                                                )),
                                                                              ],
                                                                            )),
                                                                      ),
                                                                            ...
                                                                            label: Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Center(
                                                                                    child: const Text(
                                                                                  "Approve",
                                                                                  style: TextStyle(fontFamily: 'Poppins', fontSize: 14, fontWeight: FontWeight.w400, color: Colors.white),
                                                                                )),
                                                                              ],
                                                                            )),
                                                                      ),
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Center(
                                                                        child:
                                                                            Text(
                                                                          '${formatDate(Attendancerequest.checkindate.toString())} - ${formatDate(Attendancerequest.checkoutdate.toString())}',
                                                                          style: TextStyle(
                                                                              color: Color(0xFF030303),
                                                                              fontSize: 12,
                                                                              fontFamily: 'Poppins'),
